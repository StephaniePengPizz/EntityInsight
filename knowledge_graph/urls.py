...
from knowledge_graph.views.construct_graph import load_paragraphs_and_construct_graph, export_graph
...
urlpatterns = [
    path('load-paragraphs-and-construct-graph/', load_paragraphs_and_construct_graph, name='load_paragraphs_and_construct_graph'),
